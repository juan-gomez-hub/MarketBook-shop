...
export function modal(visibility, setVisibility, divRef, padding_right = true) {
  if (visibility) {
...
export default function Dialog({ selectedCard, visibility, setVisibility }) {
  const divRef = useRef(null)


  useEffect(() => {
    modal(visibility, setVisibility, divRef)
  }, [visibility])
    ...
    <div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
      <div id="xd"
        ...
        ref={divRef}>
        {
          ...
          //  <h1 class="text-gray-200 text-3xl hover:cursor-pointer hover:text-white" onMouseDown={() => { setVisibility(false) }}>X</h1>
          //</div>
        }
        <div class="bg-gray-100 p-4 w-full">
          ...
          <div class=" flex flex-wrap gap-2">
            ...
            <input type="button" class="p-2 bg-blue-400 text-white rounded-md hover:bg-blue-500 hover:cursor-pointer" onClick={() => { addToCart(selectedCard.reference) }} value="Agregar al carrito"></input>
